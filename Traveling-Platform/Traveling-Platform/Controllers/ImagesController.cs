...
namespace Traveling_Platform.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Picture,IsProfilePic,IdHotel")] Image image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Picture,IsProfilePic,IdHotel")] Image image)
        {
            if (id != image.Id)
            {
                return NotFound();
